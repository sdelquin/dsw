...
- El tamaño del archivo comprimido **no debe superar los 20MB**. Si pesa más, es bastante probable que sea debido que estás incluyendo el entorno virtual `.venv` o a las imágenes añadidas (traten de comprimirlas y/o redimensionarlas).
