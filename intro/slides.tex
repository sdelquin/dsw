...
\begin{frame}{Instrumentos de evaluación}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Tareas evaluables: Investigación [TEI] (\textbf{30\%})
            \item Tareas evaluables: Proyectos [TEP] (\textbf{70\%})
        \end{itemize}
    \end{itemize}
...
\begin{frame}{Criterios de calificación}
    \begin{tabular}{|l|l|l|l|}
        ...
        \hline
        1ª Evaluación & 100\% & - & FEOE\\
        \hline
        2ª Evaluación & 30\%  & 70\% & FEOE\\
        \hline
    \end{tabular}\\[1em]
...
\begin{frame}{Horario}
    \begin{tabular}{|l|l|l|l|l|l|}
        ...
        14:30 - 15:25 & & & & &\\
        \hline
        15:25 - 16:20 & & & & \textcolor{purple}{DSW} &\\
        \hline
        16:20 - 17:15 & & \textcolor{purple}{DSW} & & \textcolor{purple}{DSW} & \textcolor{purple}{DSW}\\
        \hline
        17:15 - 17:45 & {\tiny Recreo} & {\tiny Recreo} & {\tiny Recreo} & {\tiny Recreo} & {\tiny Recreo}\\
        \hline
        17:45 - 18:40 & & \textcolor{purple}{DSW} & & & \textcolor{purple}{DSW}\\
        \hline
        18:40 - 19:35 & & \textcolor{purple}{DSW} & & &\\
        \hline
        19:35 - 20:30 & & & & &\\
        \hline
    \end{tabular}
