...
Es probable que el código de los ficheros de migración no cumplan con ciertas reglas de estilo. Para evitar que nos salten errores de este estilo, basta con crear un fichero `.flake8` en el raíz del proyecto con este contenido:
